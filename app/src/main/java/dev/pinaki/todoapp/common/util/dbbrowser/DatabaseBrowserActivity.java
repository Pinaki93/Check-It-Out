package dev.pinaki.todoapp.common.util.dbbrowser;
...
public class DatabaseBrowserActivity extends Activity implements OnItemClickListener {
    ...
    private Spinner spSelectTable;
    private TableLayout tableLayout;
    private LinearLayout mainLayout;
    private HorizontalScrollView hsv;
    private ScrollView mainSscrollView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new RoomDatabaseHelper(TodoDatabase.Companion.getInstance(this));

        mainSscrollView = new ScrollView(DatabaseBrowserActivity.this);
        ...
        TextView secondrowtext = new TextView(DatabaseBrowserActivity.this);
        secondrowtext.setText("No. Of Records : ");
        secondrowtext.setTextSize(20);
        secondrowtext.setLayoutParams(secondrowlp);
        tv = new TextView(DatabaseBrowserActivity.this);
        tv.setTextSize(20);
        ...
        final Button submitQuery = new Button(DatabaseBrowserActivity.this);
        ...
        submitQuery.setTextColor(Color.WHITE);
        mainLayout.addView(submitQuery);

        final TextView help = new TextView(DatabaseBrowserActivity.this);
        ...
        final Spinner spinnertable = new Spinner(DatabaseBrowserActivity.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(DatabaseBrowserActivity.this);
        previous = new Button(DatabaseBrowserActivity.this);
        ...
        next = new Button(DatabaseBrowserActivity.this);
        next.setText("Next");
        ...
        tvmessage = new TextView(DatabaseBrowserActivity.this);
        ...
        final Button customQuery = new Button(DatabaseBrowserActivity.this);
        customQuery.setText("Custom Query");
        customQuery.setTextColor(Color.WHITE);
        customQuery.setBackgroundColor(ContextCompat.getColor(this, R.color.colorAccent));
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(DatabaseBrowserActivity.this,
        ...
        if (tablenamesadapter != null) {
            //set the adpater to spSelectTable spinner
            spSelectTable.setAdapter(tablenamesadapter);
        }

        // when a table names is selecte display the table contents
        spSelectTable.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    //displaying the content of the table which is selected in the spSelectTable spinner
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DatabaseBrowserActivity.this,
                    ...
                    //getting contents of the table which user selected from the spSelectTable spinner
                    ArrayList<Cursor> alc2 = dbHelper.getData(Query2);
                    ...
                    if (c2 != null) {
                        ...
                        spinnertable.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(DatabaseBrowserActivity.this)
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> aldropt = dbHelper.getData(Query6);
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> aldeletet = dbHelper.getData(Query7);
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                                    ...
                                    final ScrollView addrowsv = new ScrollView(DatabaseBrowserActivity.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(DatabaseBrowserActivity.this);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(DatabaseBrowserActivity.this);
                                                        ...
                                                        .setPositiveButton("Add",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> altc = dbHelper.getData(Query4);
                        ...
                        for (int k = 0; k < c2.getColumnCount(); k++) {
                            LinearLayout cell = new LinearLayout(DatabaseBrowserActivity.this);
    ...
    public void getcolumnnames() {
        ArrayList<Cursor> alc3 = dbHelper.getData("PRAGMA table_info(" + indexInfo.table_name + ")");
    ...
    public void updateDeletePopup(int row) {
        ...
        final RelativeLayout lp = new RelativeLayout(DatabaseBrowserActivity.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv = new ScrollView(DatabaseBrowserActivity.this);
        LinearLayout lcrud = new LinearLayout(DatabaseBrowserActivity.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(DatabaseBrowserActivity.this,
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if (spinner_value.equalsIgnoreCase("Update this row")) {
                                                ...
                                                ArrayList<Cursor> aluc = dbHelper.getData(Query3);
                                            ...
                                            if (spinner_value.equalsIgnoreCase("Delete this row")) {
                                                ...
                                                ArrayList<Cursor> aldc = dbHelper.getData(Query5);
    ...
    public void refreshTable(int d) {
        ...
        if (d == 0) {
            ...
            ArrayList<Cursor> alc3 = dbHelper.getData(Query8);
            c3 = alc3.get(0);
            //saving cursor to the static indexinfo class which can be resued by the other functions
