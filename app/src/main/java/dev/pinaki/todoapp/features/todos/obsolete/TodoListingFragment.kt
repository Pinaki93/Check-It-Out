...
import dev.pinaki.todoapp.features.edittodo.AddEditTodoActivity
import dev.pinaki.todoapp.features.todos.obsolete.adapter.ContentItem
import dev.pinaki.todoapp.features.todos.obsolete.adapter.Listener
...
import dev.pinaki.todoapp.features.todos.obsolete.adapter.swipeanddrag.OnItemInteractionListener
import dev.pinaki.todoapp.features.todos.obsolete.adapter.swipeanddrag.TodoItemRecyclerViewCallback
import dev.pinaki.todoapp.features.todos.obsolete.bus.TodoBus
import dev.pinaki.todoapp.features.todos.obsolete.bus.TodoBusItem
import java.util.*
import kotlin.collections.ArrayList


class TodoListingFragment : Fragment(), OnItemInteractionListener,
    dev.pinaki.todoapp.features.todos.obsolete.view.OnItemInteractionListener, Listener {
